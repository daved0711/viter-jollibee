...
const Welcome = () => {
  return (
    <>
      ...
      <div className='bg-myred text-white absolute w-full bottom-0 left-0'>
      ...
      <p className='text-xs text-black opacity-60'>Lorem, ipsum dolor sit amet 
        consectetur adipisicing elit. At sunt explicabo 
        veritatis.</p>
      </div>
